...
public class FullScreenSettings : MonoBehaviour
{
    ...
    {
        new FullScreenType(FullScreenMode.ExclusiveFullScreen, "Pantalla Completa"),
        new FullScreenType(FullScreenMode.FullScreenWindow, "Sin Bordes"),
        new FullScreenType(FullScreenMode.Windowed, "Ventana")
    };
